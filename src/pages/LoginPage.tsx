...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-muted/30 dark:bg-background transition-colors duration-300">
      <div className="w-full max-w-4xl p-0 bg-white dark:bg-gray-800 rounded-lg shadow-lg transition-colors duration-300 flex flex-row overflow-hidden">
        {/* Logo section */}
        <div className="hidden md:flex items-center justify-center bg-gray-100 dark:bg-gray-900" style={{ width: '50%' }}>
          <img src={levelsLogo} alt="Levels Logo" className="object-contain w-full h-full p-8" />
        </div>
        {/* Form section */}
        <div className="w-full md:w-1/2 p-16 space-y-8 flex flex-col justify-center">
          <div className="text-center">
            <span className="font-bold text-2xl dark:text-white transition-colors duration-300">PadelPro Manager</span>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white transition-colors duration-300 mt-2">Welcome</h2>
              ...
              <Form {...loginForm}>
                <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-6">
                  ...
                  <div className="flex justify-center">
                    <Button 
                      type="submit" 
                      className="bg-padel-primary hover:bg-padel-primary/90" 
